...
################# Flatten LEVEL 4 ####################
dat1 <- markdata %>% filter(., workflow_id == 25364)
...
flattened$tool_label <- ifelse(flattened$toolIndex ==1, "Cobia",
                           ifelse(flattened$toolIndex ==0, "Dolphin",
                              ifelse(flattened$toolIndex ==2, "Triggerfish",
                                  ifelse(flattened$toolIndex ==3, "Little Tunny","Other"))))
